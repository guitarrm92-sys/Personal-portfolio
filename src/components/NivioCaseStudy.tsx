    ...
    <div className="min-h-screen bg-[#F8FAFC] text-[#1E293B] font-sans selection:bg-[#2B98C4] selection:text-white">
      ...
      <section className="relative min-h-[700px] lg:h-screen flex items-center overflow-hidden bg-white pt-16">
        <div className="absolute inset-0 z-0">
          <img 
            src="/assets/images/nivio%20images/Fondo%20nivio%20hero.png" 
            alt="Background" 
            className="w-full h-full object-cover hidden md:block"
            referrerPolicy="no-referrer"
          />
          <img 
            src="/assets/images/nivio%20images/Fondo-nivio-movil.png" 
          ...
          >
            ...
            <div>
              ...
              <div className="bg-[#FFFFFF] border border-[#E2E8F0] rounded-xl p-4 lg:p-12 shadow-sm">
                <img 
                  src="/assets/images/nivio images/Arquitectura de la información nivio.png" 
                        ...
                        <div className="w-full flex-grow flex flex-col items-center justify-center p-4">
                           {(activeStructureTab === "Inicio" || activeStructureTab === "Transacciones" || activeStructureTab === "Facturas" || activeStructureTab === "Pagos" || activeStructureTab === "Tarjetas" || activeStructureTab === "Historicos") ? (
                              <div className="w-full h-full flex flex-col items-center justify-center">
                                <embed 
                                  src={`/assets/images/nivio%20images/${activeStructureTab}%20nivio.pdf`}
                                ...
                                <div className="mt-4 text-xs text-gray-400">
                                  ...
                                  <a 
                                    href={`/assets/images/nivio%20images/${activeStructureTab}%20nivio.pdf`}
                                    target="_blank" 
                ...
                {[...Array(15)].map((_, i) => (
                  ...
                  >
                    <div className="aspect-[9/16] bg-white rounded-xl border border-gray-100 overflow-hidden shadow-sm group-hover:shadow-xl transition-all cursor-zoom-in relative">
                       <img 
                         src={`/assets/images/nivio%20images/mid%20wire%20frame%20nivio/screen_fix_${i+1}.png`}
                    ...
                    {[...Array(24)].map((_, i) => (
                      <div key={i} className="flex-none w-[220px] aspect-[9/18.5] bg-[#0F172A] rounded-[2rem] p-2 shadow-lg overflow-hidden">
                        <div className="w-full h-full bg-white rounded-[1.5rem] overflow-hidden">
                          <img 
                            src={`/assets/images/nivio%20images/Hi%20fi%20wireframe%20nivio/${i + 1}.png`}
                            alt={`Wireframe ${i + 1}`}
                            className="w-full h-full object-cover"
                            referrerPolicy="no-referrer"
                          />
                  ...
                  >
                    {[...Array(24)].map((_, i) => (
                      <div key={i + 24} className="flex-none w-[220px] aspect-[9/18.5] bg-[#0F172A] rounded-[2rem] p-2 shadow-lg overflow-hidden">
                        <div className="w-full h-full bg-white rounded-[1.5rem] overflow-hidden">
                          <img 
                            src={`/assets/images/nivio%20images/Hi%20fi%20wireframe%20nivio/${i + 25}.png`}
                            alt={`Wireframe ${i + 25}`}
                            className="w-full h-full object-cover"
                            referrerPolicy="no-referrer"
                          />
                    ...
                    <div className="relative w-full max-w-[280px] md:max-w-full h-full">
                        ...
                        >
                          <div className="w-full h-full bg-white rounded-[2rem] overflow-hidden">
                            <img src="/assets/images/nivio%20images/Hi%20fi%20wireframe%20nivio/2.png" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                          </div>
                        </motion.div>
                        <motion.div 
                          initial={{ rotate: 10, x: 20 }}
                        ...
                        >
                          <div className="w-full h-full bg-white rounded-[2rem] overflow-hidden">
                            <img src="/assets/images/nivio%20images/Hi%20fi%20wireframe%20nivio/44.png" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                          </div>
                        </motion.div>
                    </div>
                  </div>
